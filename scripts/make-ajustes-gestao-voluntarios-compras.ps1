...
$ZipPath = Join-Path $OutputDir "tucxa-ajustes-gestao-voluntarios-compras.zip"
...
$TempRoot = Join-Path $env:TEMP ("tucxa-ajustes-gestao-voluntarios-compras-" + [guid]::NewGuid().ToString())
