...
$ZipPath = Join-Path $OutputDir "tucxa-ajustes-caixa-mobile-pedido.zip"
...
$TempRoot = Join-Path $env:TEMP ("tucxa-ajustes-caixa-mobile-" + [guid]::NewGuid().ToString())
...
$ItemsToCopy = @(
  ...
  "src\components\cashier-dashboard.tsx",
  "src\components\cashier-responsible-list.tsx",
  "src\components\cashier-responsible-detail.tsx",
