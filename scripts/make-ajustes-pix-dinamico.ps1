...
$ZipPath = Join-Path $OutputDir "tucxa-ajustes-pix-dinamico.zip"
...
$TempRoot = Join-Path $env:TEMP ("tucxa-ajustes-pix-dinamico-" + [guid]::NewGuid().ToString())
...
$ItemsToCopy = @(
  ...
  "src\app\minha-compra",
  "src\app\cardapio",
  "src\app\gestao-evento",
  "src\app\admin\festa-junina\pagamentos",
  "src\app\admin\festa-junina\pedidos",
  "src\app\admin\festa-junina\caixa",
