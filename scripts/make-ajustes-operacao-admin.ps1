...
$ZipPath = Join-Path $OutputDir "tucxa-ajustes-operacao-admin.zip"
...
$TempRoot = Join-Path $env:TEMP ("tucxa-ajustes-operacao-admin-" + [guid]::NewGuid().ToString())
...
$ItemsToCopy = @(
  ...
  "src\app\admin\festa-junina\checkin",
  "src\app\admin\festa-junina\atendimento",
  "src\app\admin\festa-junina\pedidos",
  "src\app\admin\festa-junina\preparo",
  "src\app\admin\festa-junina\retirada",
  "src\app\admin\festa-junina\entrega",
  "src\app\admin\festa-junina\ocorrencias",
