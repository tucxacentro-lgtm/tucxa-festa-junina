...
export const DEFAULT_ADMIN_MENU_ITEMS: AdminMenuCatalogItem[] = [
  ...
  menuItem('operacao_atendimento_garcom', 'Garçom', 'Evento selecionado', 'operacao_atendimento', '/admin/festa-junina/garcom', 442, 'Pedidos por mesa ou cliente para atendimento/garçom.', 'operation'),
  menuItem('operacao_atendimento_pedidos', 'Pedidos', 'Evento selecionado', 'operacao_atendimento', '/admin/festa-junina/pedidos', 443, 'Vendas de itens do cardápio no dia do evento.', 'operation'),
  menuItem('operacao_atendimento_preparo', 'Preparo', 'Evento selecionado', 'operacao_atendimento', '/admin/festa-junina/modulo/operacao_atendimento_preparo', 444, 'Produção conforme pedido e receita.', 'operation'),
  menuItem('operacao_atendimento_retirada', 'Retirada', 'Evento selecionado', 'operacao_atendimento', '/admin/festa-junina/modulo/operacao_atendimento_retirada', 445, 'Retirada pelo garçom ou diretamente pelo cliente.', 'operation'),
  ...
  menuItem('operacao_atendimento_caixa', 'Caixa', 'Evento selecionado', 'operacao_atendimento', '/admin/festa-junina/caixa', 447, 'Pagamentos e fechamento de caixa.', 'operation'),
