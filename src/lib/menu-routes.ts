...
export const MENU_ROUTE_OPTIONS: MenuRouteOption[] = [
  ...
  { group: "Evento selecionado", label: "Preparo", path: "/admin/festa-junina/modulo/operacao_atendimento_preparo", description: "Fila e preparo." },
  { group: "Evento selecionado", label: "Retirada", path: "/admin/festa-junina/modulo/operacao_atendimento_retirada", description: "Retirada no balcão." },
  { group: "Evento selecionado", label: "Entrega", path: "/admin/festa-junina/entrega", description: "Entrega ao cliente." },
  { group: "Evento selecionado", label: "Caixa", path: "/admin/festa-junina/caixa", description: "Pagamento e caixa." },
